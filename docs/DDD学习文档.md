...
#### 培训聚合 ([Training](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/domain/training/Training.java))
```java
@Aggregate
...
#### 培训票聚合 ([Ticket](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/domain/ticket/Ticket.java))
```java
@Aggregate
public class Ticket {
    private TicketId id;
...
#### TicketId 值对象 ([TicketId](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/domain/ticket/TicketId.java))
```java
...
#### 身份标识基类 ([AbstractIdentity](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/domain/AbstractIdentity.java))
```java
...
#### 提名服务 ([NominationService](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/domain/ticket/NominationService.java))
```java
@Service
@DomainService
...
#### 仓储端口 ([TicketRepository](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/south/port/repository/TicketRepository.java))
```java
@Mapper
@Repository
...
对外暴露的接口：
- **REST资源** - [TicketResource](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/north/remote/resource/TicketResource.java)
- **应用服务** - [NominationAppService](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/north/local/appservice/NominationAppService.java)
...
与外部系统交互的接口：
- **仓储端口** - 数据持久化
- **外部客户端端口** - [NotificationClient](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/south/port/client/NotificationClient.java)
...
| 注解 | 用途 |
|------|------|
| [@Aggregate](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/stereotype/Aggregate.java) | 标识聚合根 |
| [@DomainService](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/stereotype/DomainService.java) | 标识领域服务 |
| [@Port](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/stereotype/Port.java) | 标识端口 |
| [@Adapter](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/stereotype/Adapter.java) | 标识适配器 |
| [@Remote](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/stereotype/Remote.java) | 标识远程资源 |
| [@Local](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/stereotype/Local.java) | 标识本地服务 |
...
### 6.2 领域模型测试示例
[TicketTest](file:///workspace/eas-training/src/test/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/domain/ticket/TicketTest.java)
```java
...
### 核心框架
- [AbstractIdentity.java](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/domain/AbstractIdentity.java) - ID基类
- [Aggregate.java](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/stereotype/Aggregate.java) - 聚合注解
- [Port.java](file:///workspace/ddd-core/src/main/java/xyz/zhangyi/ddd/core/stereotype/Port.java) - 端口注解
...
- [NominationService.java](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/domain/ticket/NominationService.java) - 提名服务
- [NominationAppService.java](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/north/local/appservice/NominationAppService.java) - 提名应用服务
- [TicketResource.java](file:///workspace/eas-training/src/main/java/xyz/zhangyi/ddd/eas/valueadded/trainingcontext/north/remote/resource/TicketResource.java) - 票资源
...
- [项目Wiki](https://github.com/agiledon/eas-ddd/wiki)
- GitChat课程：《领域驱动设计实战（战略篇）》《领域驱动设计实战（战术篇）》
- [JPA版本参考项目](https://github.com/agiledon/payroll-ddd)
